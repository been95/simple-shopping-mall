const detailedMock = [
    ...
    { id: "daily_mono",type:"카시트", title: "[순성] 데일리모노 ISOFIX_카시트", desc: "신생아~7세까지 사용가능", image: "../img/daily_mono.png",imageitem:"img/daily_mono_item.jpg", options: [ { optionType: "색상선택", optionValues: ["모노블랙"],},], weight:"8.5kg",cost:"390,000원",sale:"298,000원", details:"daily_mono_details.jpg" },
